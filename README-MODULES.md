...
Serwer ASP.NET Core 9.0 obsługujący katalog filmów i streaming MPEG-DASH z zaawansowanymi mechanizmami wydajnościowymi i bezpieczeństwa.
...
**Strategie cache:**
- `/api/catalog` - 5 min (tag: `catalog`, vary: `limit,offset,search`)
...
**Plik `.key`:** Zawiera raw hex CEK (np. `a1b2c3d4e5f6...`) - **MUST** być zapisany w bazie DRM Server z envelope encryption.
